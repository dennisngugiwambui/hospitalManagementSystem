            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <a class="sidebar-link" href="{{ route('profile', $name) }}">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('pharmacy') }}">
                            <i class="align-middle" data-feather="map"></i> <span class="align-middle">Pharmacy</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('admitted') }}">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('paid_cases') }}">
