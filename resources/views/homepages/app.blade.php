...
<head>
	...
	<!-- CSS here -->
	<link rel="stylesheet" href="{{ asset('homepages/assets/css/bootstrap.min.css') }}">
	<link rel="stylesheet" href="{{ asset('homepages/assets/css/owl.carousel.min.css') }}">
	<link rel="stylesheet" href="{{ asset('homepages/assets/css/slicknav.css') }}">
    <link rel="stylesheet" href="{{ asset('homepages/assets/css/flaticon.css') }}">
    <link rel="stylesheet" href="{{ asset('homepages/assets/css/gijgo.css') }}">
    <link rel="stylesheet" href="{{ asset('homepages/assets/css/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('homepages/assets/css/animated-headline.css') }}">
	<link rel="stylesheet" href="{{ asset('homepages/assets/css/magnific-popup.css') }}">
	<link rel="stylesheet" href="{{ asset('homepages/assets/css/fontawesome-all.min.css') }}">
	<link rel="stylesheet" href="{{ asset('homepages/assets/css/themify-icons.css') }}">
	<link rel="stylesheet" href="{{ asset('homepages/assets/css/slick.css') }}">
	<link rel="stylesheet" href="{{ asset('homepages/assets/css/nice-select.css') }}">
	<link rel="stylesheet" href="{{ asset('homepages/assets/css/style.css') }}">
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="{{ asset('homepages/assets/img/logo/loder.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
...
<main>
    ...
    <script src="{{ asset('./homepages/assets/js/vendor/modernizr-3.5.0.min.js') }}"></script>
