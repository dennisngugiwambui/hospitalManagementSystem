  ...
  <div class="container">
    ...
    <div class="modal fade" id="addMedicine" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('pharmacy')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="mb-3 row">
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <table class="table" id="myTable">
          ...
          <tbody>
            <?php $__currentLoopData = $pharmacy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td>
                ...
                <td>
                  <button type="submit" class="btn btn-danger btn-sm"> <?php echo e($medicine->id); ?></button>
            ...
            <div class="card-body">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                        <form action="<?php echo e(route('pharmacy_patient')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3 row">
                              ...
                              <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                  <select class="form-select" name="medicine[]" id="">
                                    ...
                                    <?php $__currentLoopData = $pharmacy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option class="form-control"><?php echo e($medicine->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  </select>
    ...
    $(document).ready(function() {
        ...
        $(add_button).click(function(e){
            ...
            if(x < max_fields){
                ...
                //add input field
                $(wrapper).append('<div class="wrapper" style="padding-top: 10px;"><select class="form-control forme" id="medicine' + x + '" name="medicine[]"><option disabled>--select--</option><?php $__currentLoopData = $pharmacy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option><?php echo e($ph->medicine_name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select><div class="input-group-append"><button class="btn btn-secondary remove-medicine" type="button">-</button></div></div>');
            }
        });
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel1\HospitalManagementSystem\resources\views/admin/pharmacy.blade.php ENDPATH**/ ?>