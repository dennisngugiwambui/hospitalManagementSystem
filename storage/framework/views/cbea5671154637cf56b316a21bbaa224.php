...
<div class="dashboard">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a href="<?php echo e(route('allusers', Auth::user()->id)); ?>">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <span class="count"><?php echo e($wards); ?></span>
        <a href="/wards">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <span class="count"><?php echo e($pharmacy); ?></span>
        <a href="/pharmacy">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <span class="count"><?php echo e($patients); ?></span>
        <a href="/receptionist">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <span class="count"><?php echo e($treatment); ?></span>
        <a href="/treatment">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <span class="count"><?php echo e($lab_test); ?></span>
        <a href="/laboratory">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <span class="count"><?php echo e($doctors); ?></span>
        <a href="<?php echo e(route('doctors', Auth::user()->id)); ?>">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <span class="count"><?php echo e($contact); ?></span>
        <a href="/contacted">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <span class="count"><?php echo e($booked); ?></span>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel1\HospitalManagementSystem\resources\views/admin/index.blade.php ENDPATH**/ ?>