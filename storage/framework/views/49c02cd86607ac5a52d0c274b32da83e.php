...
<div class="container">
    <div class="row justify-content-center mt-5">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-dark text-light"><?php echo e(__('Register')); ?></div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <?php if(Route::has('password.request')): ?>
                                    <a class="btn btn-link" style="background: crimson; color:black;" href="<?php echo e(route('password.request')); ?>">
...
<?php echo $__env->make('homepages.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel1\HospitalManagementSystem\resources\views/auth/register.blade.php ENDPATH**/ ?>