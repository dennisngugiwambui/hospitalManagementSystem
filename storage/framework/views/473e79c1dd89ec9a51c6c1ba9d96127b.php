        ...
        <div class="row">
            <div class="col-lg-6 col-md-10">
                <div class="about-caption mb-50">
                    ...
                    <div class="about-btn1 mb-30">
                        <a href="<?php echo e(route('appointments')); ?>" class="btn about-btn2">Appointment <i class="ti-arrow-right"></i></a>
                    </div>
                    <div class="about-btn1 mb-30">
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <div class="about-img ">
                    <div class="about-font-img d-none d-lg-block">
                        <img src="<?php echo e(asset('homepages/assets/img/gallery/about2.png')); ?>" alt="">
                    </div>
                    <div class="about-back-img ">
                        <img src="<?php echo e(asset('homepages/assets/img/gallery/about1.png')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    <div class="row align-items-center no-gutters">
                        ...
                        <div class="col-lg-5">
                            <div class="dept_thumb">
                                <img src="<?php echo e(asset('homepages/assets/img/gallery/department_man.png')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- single_content  -->
                ...
                <div class="tab-pane fade" id="Neuroanatomy" role="tabpanel" aria-labelledby="Neuroanatomy-tab">
                    ...
                    <div class="row align-items-center no-gutters">
                        ...
                        <div class="col-lg-5">
                            <div class="dept_thumb">
                                <img src="<?php echo e(asset('homepages/assets/img/neutronomy.jpg')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- single_content  -->
                ...
                <div class="tab-pane fade" id="Blood" role="tabpanel" aria-labelledby="Blood-tab">
                    ...
                    <div class="row align-items-center no-gutters">
                        ...
                        <div class="col-lg-5">
                            <div class="dept_thumb">
                                <img src="<?php echo e(asset('homepages/assets/img/blood-screening.jpg')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- single_content  -->
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="imagename/<?php echo e($doctor->image); ?>" style="width:360px; height:444px" alt="">
                    </div>
                    <div class="team-caption">
                        <h3><a href="#"><?php echo e($doctor->name); ?></a></h3>
        ...
        <div class="row justify-content-end">
            <div class="col-xl-7 col-lg-7">
                <div class="form-wrapper">
                    ...
                    <!--End Section Tittle  -->
                    <form id="contact-form" action="<?php echo e(route('appointment_add')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 mb-30">
                                <div class="select-itms">
                                    <select name="doctor" id="select2" required>
                                        ...
                                        <option value="<?php echo e($user->name); ?>"><?php echo e($user->name); ?> - <?php echo e($user->speciality); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<?php echo $__env->make('homepages.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel1\HospitalManagementSystem\resources\views/homepages/index.blade.php ENDPATH**/ ?>